...
const statusColors: Record<string, string> = {
  op_voorraad: "bg-state-success-bg text-state-success-text",
  bijna_op: "bg-state-warning-bg text-state-warning-text",
  besteld: "bg-state-info-bg text-state-info-text",
  niet_beschikbaar: "bg-state-error-bg text-state-error-text",
}
