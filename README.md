# VEHA Dashboard — Design Handoff

This folder contains everything needed to implement VEHA Dashboard.
...
| # | Section | Description |
|---|---------|-------------|
| 1 | Foundation | Design tokens, data model, routing |
| 2 | Dashboard | Stats, today's tasks, active projects, capacity |
| 3 | Clients | Hierarchical tree view with contacts, locations, projects |
| 4 | Projects | Gantt chart with tasks, dependencies, resources |
| 5 | Employees | Team management with skills and availability |
| 6 | Weekplanning | Weekly calendar showing who works where |
